    ...
    return (
        <div className="container">
            ...
            <form onSubmit={(e) => {e.preventDefault(); cadastrarUsuario()}}>
                ...
                <input type="text" id="posicao" placeholder="Posicao" value={posicao} onChange={(e) => setPosicao(e.target.value)} required />
                <input type="text" id="numCamisa" placeholder="Numero da Camisa" value={numCamisa} onChange={(e) => setNumCamisa(e.target.value)} required />
